...
function PendingFeesStudentsClerk() {
  ...
  const { loading, setLoading, courses , institutes } = useContext(ClerkDataContext);
  ...
  useEffect(() => {
    ...
    if (selectedInstitute) {
      students = studentPending.filter(
        (student) => student.student.institute_name === selectedInstitute
      );
    }
              ...
              <table className="min-w-full">
                ...
                <tbody className="bg-white">
                  {filteredStudents.length > 0 ? (
                    ...
                    <div className="text-center flex justify-center text-[18px] w-[100%]">
                      No data found
                    </div>
                  )}
                </tbody>
